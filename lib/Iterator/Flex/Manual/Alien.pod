...
Interfacing is accomplished by composing the appropriate
L<Iterator::Flex::Role::Wrap> roles with the iterator class.

The two behaviors that need translating are
