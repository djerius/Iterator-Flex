...
L<Iterator::Flex::Manal::PriorArt> for how other languages and Perl
modules handle it.
...
are documented in L<Iterator::Manual::Overview>, and are

=over

=item *

L<next|Iterator::Manual::Overview/next>

=item *

L<current|Iterator::Manual::Overview/current>

=item *

L<prev|Iterator::Manual::Overview/prev>

=item *

L<rewind|Iterator::Manual::Overview/rewind>

=item *

L<reset|Iterator::Manual::Overview/reset>

=item *

L<freeze|Iterator::Manual::Overview/freeze>

=item *

L<thaw|Iterator::Manual::Overview/thaw>
